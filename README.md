...
---Determine the titles of employees who are expected to retire, using the previously-created table retirement_info
...
--- List of current employees born in 1965 and Join emp_info with salaries data
...
-- Determine if there are duplicates in Mentor Eligibility table, to see if a partition is necessary, by comparing unique records with the number of records in Mentor_Eligibility
